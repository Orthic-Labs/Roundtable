// Run with: node --test 'tools/citadel/packages/hub/src/cancel.test.mjs'
//
// The Cancellation contract from 2026-07-22-citadel-cross-device-architecture.md, clause by
...
test('a store can be reopened — the migration is not re-applied on restart', () => {
  ...
  // user_version now, matching citadel-store's open_connection.
