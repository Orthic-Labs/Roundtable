...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Citadel-specific field through an otherwise protocol-agnostic module.
...
/// rooms, deliveries, or approvals; those are Citadel concepts, so they live here instead of
