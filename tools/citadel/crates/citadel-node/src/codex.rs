...
//! `turn/interrupt`) are taken from `2026-07-22-citadel-cross-device-architecture.md` and
    ...
    async fn notification_to_event(
        ...
        let (thread_id, turn_id, status, body, approval) = match method {
            ...
            "item/autoApprovalReview/started" | "item/autoApprovalReview/completed" => {
                ...
                // state Citadel must surface as an approval. Everything else is informational.
