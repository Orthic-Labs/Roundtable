...
- **Done check:** CHECK:node /Volumes/D/claude/roundtable/tools/citadel/tests/e2e/provider-session-probe.mjs --platforms mac,windows --providers codex,claude --require-current-session
...
- **Done check:** CHECK:node --test /Volumes/D/claude/roundtable/tools/citadel/packages/hub/src/invites.test.mjs
...
- **Done check:** CHECK:cargo test --manifest-path /Volumes/D/claude/roundtable/tools/citadel/Cargo.toml -p citadel-node invite_join -- --nocapture
...
- **Action:** ACTION:Build one local citadel_join_url MCP channel with provider binders that resume the exact Codex thread, bind the exact Claude channel connection, and expose a stable adapter interface for future engines.
...
- **Done check:** CHECK:npm test --prefix /Volumes/D/claude/roundtable/tools/citadel/packages/join-channel
...
- **Done check:** CHECK:/Volumes/D/claude/roundtable/tools/citadel/packages/web/node_modules/.bin/vitest run /Volumes/D/claude/roundtable/tools/citadel/packages/web/src/components/InviteAgent.test.tsx /Volumes/D/claude/roundtable/tools/citadel/packages/web/src/App.test.tsx
...
- **Done check:** CHECK:node /Volumes/D/claude/roundtable/tools/citadel/tests/e2e/invite-join.mjs --platforms mac,windows --providers codex,claude --require-current-session
...
- **Done check:** CHECK:node /Volumes/D/claude/roundtable/tools/citadel/tests/e2e/invite-join.mjs --production --platforms mac,windows --providers codex,claude --require-current-session
...
- **Final verification:** node /Volumes/D/claude/roundtable/tools/citadel/tests/e2e/invite-join.mjs --production --platforms mac,windows --providers codex,claude --require-current-session
